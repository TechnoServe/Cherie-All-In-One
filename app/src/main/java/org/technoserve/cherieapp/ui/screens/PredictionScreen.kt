    ...
    Scaffold(
        ...
        Column(
            ...
            if (complete.value) {
                ...
                Text(
                    text = "${stringResource(id = R.string.ripeness)}: ${calculateRipenessScore(ScoreType.RIPE).toInt()}%",
                ...
                Box(
                    ...
                    Row(
                        ...
                        Text(
                            text = "${stringResource(id = R.string.underripe)}: ${calculateRipenessScore(ScoreType.UNDERRIPE).toInt()}%",
                        ...
                        Text(
                            text = "${stringResource(id = R.string.overripe)}: ${calculateRipenessScore(ScoreType.OVERRIPE).toInt()}%",
                ...
                ButtonPrimary(onClick = {
                    ...
                    context.finish()
                    upload(item)
                    Log.d("coordinates",mylocation.value)
